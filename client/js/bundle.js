...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = __webpack_require__(167).render;
	var thunkMiddleware = __webpack_require__(168);
	var loggerMiddleware = __webpack_require__(169)();
	var Provider = __webpack_require__(170).Provider;
	var router = __webpack_require__(179);

	var Root = __webpack_require__(226).Root;
	var Common = __webpack_require__(229);
	var GetInitialState = __webpack_require__(229).GetInitialState;

	//smart components
	var MathController = __webpack_require__(246).MathController;
	var LobbyController = __webpack_require__(247).LobbyController;
	var HoldemController = __webpack_require__(248).HoldemController;
	var AsyncController = __webpack_require__(249).AsyncController;
	var AuthController = __webpack_require__(250).AuthController;
	var IndexController = __webpack_require__(251).IndexController;
	var Logout = __webpack_require__(250).Logout;

	//actions
	var Nav = __webpack_require__(232);

	var createStoreWithMiddleware = Redux.applyMiddleware(thunkMiddleware, loggerMiddleware)(Redux.createStore);
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            router.Link,
	                            { className: "item", onClick: Common.SetPath(store), to: "/" },
	                            "Index"
	                        ),
	                        React.createElement(
	                            router.Link,
	                            { className: "item", onClick: Common.SetPath(store), to: "/math" },
	                            "Math"
	                        ),
	                        React.createElement(
	                            router.Link,
	                            { className: "item", onClick: Common.SetPath(store), to: "/lobby" },
	                            "Lobby"
	                        ),
	                        React.createElement(
	                            router.Link,
	                            { className: "item", onClick: Common.SetPath(store), to: "/auth" },
	                            "Auth"
	                        ),
	                        React.createElement(
	                            "div",
	...
	render(React.createElement(
	    ...
	    React.createElement(
	        router.Route,
	        { path: "/", component: App },
	        React.createElement(router.IndexRoute, { component: IndexController }),
	        React.createElement(router.Route, { path: "math", component: MathController, onEnter: Common.RequireAuth(store) }),
	        React.createElement(
	            router.Route,
	            { path: "lobby" },
	            React.createElement(router.IndexRoute, { component: LobbyController, onEnter: Common.RequireAuth(store) }),
	            React.createElement(router.Route, { path: "/holdem/:gameid", component: HoldemController, onEnter: Common.RequireAuth(store) })
	        ),
	        React.createElement(router.Route, { path: "async", component: AsyncController }),
	        React.createElement(router.Route, { path: "auth", component: AuthController })
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Redux = __webpack_require__(1);
	var Math = __webpack_require__(227).Math;
	var Lobby = __webpack_require__(238).Lobby;
	var Holdem = __webpack_require__(240).Holdem;
	var Async = __webpack_require__(242).Async;
	var Auth = __webpack_require__(243).Auth;
	var Nav = __webpack_require__(244).Nav;
	var Account = __webpack_require__(245).Account;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MathActions = __webpack_require__(228);
	var Auth = __webpack_require__(233);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Config = __webpack_require__(229).Config;
	var Auth = __webpack_require__(233);
	var Nav = __webpack_require__(232);
	var Actions = __webpack_require__(234).Actions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reactCookie = __webpack_require__(230);
	var Nav = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cookie = __webpack_require__(231);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Account = __webpack_require__(237)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lobby = __webpack_require__(239);
	var Auth = __webpack_require__(233);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Holdem = __webpack_require__(241);
	var Lobby = __webpack_require__(239);
	var Auth = __webpack_require__(233);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Counter, [{
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: "ui massive black label" },
	                    " ",
	                    this.props.count,
	                    " "
	                ),
	                ...
	                React.createElement(
	                    "button",
	                    { className: "ui olive button", onClick: this.props.increment },
	                    "Increment"
	                ),
	                React.createElement(
	                    "button",
	                    { className: "ui green button", onClick: this.props.decrement },
	                    "Decrement"
	                ),
	                React.createElement(
	                    "button",
	                    { className: "ui teal button", onClick: this.props.square },
	                    "Square"
	                ),
	                React.createElement(
	                    "button",
	                    { className: "ui blue button", onClick: this.props.sqrt },
	                    "Sqrt"
	                )
	            );
	        }
	...
	var MathController = function (_React$Component2) {
	    _inherits(MathController, _React$Component2);

	    function MathController(props) {
	        _classCallCheck(this, MathController);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(MathController).call(this, props));

	        _this2.increment = _this2.increment.bind(_this2);
	        _this2.decrement = _this2.decrement.bind(_this2);
	        _this2.square = _this2.square.bind(_this2);
	        _this2.sqrt = _this2.sqrt.bind(_this2);
	        return _this2;
	    }

	    _createClass(MathController, [{
	        key: "componentDidMount",
	        value: function componentDidMount() {
	        ...
	        value: function render() {
	            ...
	            if (this.props.initialized) {
	                data = React.createElement(Counter, {
	...
	var dataMapper = function dataMapper(state) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateGameForm = function (_React$Component) {
	    _inherits(CreateGameForm, _React$Component);

	    function CreateGameForm(props) {
	        _classCallCheck(this, CreateGameForm);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CreateGameForm).call(this, props));

	        _this.changeGameName = _this.changeGameName.bind(_this);
	        _this.changeGameType = _this.changeGameType.bind(_this);
	        _this.state = { gameType: "", gameName: "" };
	        return _this;
	    }

	    _createClass(CreateGameForm, [{
	        key: "changeGameName",
	        value: function changeGameName(event) {
	            this.setState({ gameName: event.target.value });
	        }
	    }, {
	        key: "changeGameType",
	        value: function changeGameType(event) {
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    "select",
	                    { className: "ui selection dropdown", onChange: this.changeGameType },
	                    React.createElement(
	                        "option",
	                        { value: "" },
	                        "Game Type"
	...
	var JoinGameListing = function (_React$Component2) {
	    _inherits(JoinGameListing, _React$Component2);

	    function JoinGameListing() {
	        _classCallCheck(this, JoinGameListing);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(JoinGameListing).apply(this, arguments));
	    }

	    _createClass(JoinGameListing, [{
	        key: "render",
	        value: function render() {
	            var players = [];
	...
	var GameList = function (_React$Component3) {
	    ...
	    _createClass(GameList, [{
	        ...
	        value: function render() {
	            ...
	            for (var i = 0; i < keys.length; i++) {
	                var key = keys[i];
	                gameRows.push(React.createElement(JoinGameListing, {
	            ...
	            return React.createElement(
	                "table",
	                { className: "ui inverted selectable single line table" },
	                React.createElement(
	                    "thead",
	                    null,
	                    React.createElement(
	...
	var LobbyController = function (_React$Component4) {
	    _inherits(LobbyController, _React$Component4);

	    function LobbyController(props) {
	        _classCallCheck(this, LobbyController);

	        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(LobbyController).call(this, props));

	        _this4.createGame = _this4.createGame.bind(_this4);
	        _this4.joinGame = _this4.joinGame.bind(_this4);
	        return _this4;
	    }
	    ...
	    _createClass(LobbyController, [{
	        ...
	        key: "createGame",
	        value: function createGame(createGameName, createGameType) {
	            Lobby.Create(this.props.dispatch, this.props.wsConnection, createGameName, createGameType);
	        }
	    }, {
	        key: "joinGame",
	        value: function joinGame(gameID) {
	            Lobby.Join(this.props.dispatch, this.props.wsConnection, gameID);
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            if (this.props.initialized) {
	                ...
	                data = React.createElement(
	                    "div",
	                    null,
	                    React.createElement(CreateGameForm, { gameName: "", createGame: this.createGame }),
	                    React.createElement("br", null),
	                    React.createElement(GameList, _extends({}, games, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HoldemMenu = function (_React$Component) {
	    _inherits(HoldemMenu, _React$Component);

	    function HoldemMenu() {
	        _classCallCheck(this, HoldemMenu);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(HoldemMenu).apply(this, arguments));
	    }

	    _createClass(HoldemMenu, [{
	        key: "render",
	        value: function render() {
	            var players = [];
	            for (var i = 0; i < this.props.game.players.length; i++) {
	...
	var HoldemTable = function (_React$Component2) {
	    _inherits(HoldemTable, _React$Component2);

	    function HoldemTable() {
	        _classCallCheck(this, HoldemTable);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(HoldemTable).apply(this, arguments));
	    }

	    _createClass(HoldemTable, [{
	        key: "render",
	        value: function render() {
	            return React.createElement(
	                "div",
	                ...
	                React.createElement(
	                    "div",
	                    { className: "ui three column stackable padded middle aligned centered color grid" },
	                    React.createElement("div", { className: "orange column" }),
	                    "game place holder",
	                    React.createElement("div", { className: "violet column" })
	                )
	            );
	        }
	    }]);
	...
	var HoldemController = function (_React$Component3) {
	    _inherits(HoldemController, _React$Component3);

	    function HoldemController(props) {
	        _classCallCheck(this, HoldemController);

	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(HoldemController).call(this, props));

	        _this3.leaveGame = _this3.leaveGame.bind(_this3);
	        return _this3;
	    }

	    _createClass(HoldemController, [{
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            Auth.wsConnect(this.props.dispatch, this.props.wsConnection);
	        ...
	        value: function leaveGame() {
	            Lobby.Leave(this.props.dispatch, this.props.wsConnection, this.props.params.gameid);
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            return React.createElement(
	                "div",
	                null,
	                React.createElement(HoldemMenu, _extends({}, game, {
	                    leaveGame: this.leaveGame
	                })),
	                React.createElement("br", null),
	                React.createElement(HoldemTable, game)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GetWidget = function (_React$Component) {
	    _inherits(GetWidget, _React$Component);

	    function GetWidget() {
	        _classCallCheck(this, GetWidget);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(GetWidget).apply(this, arguments));
	    }

	    _createClass(GetWidget, [{
	        key: "render",
	        value: function render() {
	            var data = React.createElement(
	                "div",
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    "button",
	                    { onClick: this.props.getA },
	                    "Get A"
	                ),
	                React.createElement(
	                    "button",
	                    { onClick: this.props.getB },
	                    "Get B"
	                )
	            );
	        }
	...
	var AsyncController = function (_React$Component2) {
	    _inherits(AsyncController, _React$Component2);

	    function AsyncController(props) {
	        _classCallCheck(this, AsyncController);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(AsyncController).call(this, props));

	        _this2.getA = _this2.getA.bind(_this2);
	        _this2.getB = _this2.getB.bind(_this2);
	        return _this2;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginCreateForm = function (_React$Component) {
	    _inherits(LoginCreateForm, _React$Component);

	    function LoginCreateForm(props) {
	        _classCallCheck(this, LoginCreateForm);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LoginCreateForm).call(this, props));

	        _this.changeUsername = _this.changeUsername.bind(_this);
	        _this.changePassword = _this.changePassword.bind(_this);
	        _this.changeRepeat = _this.changeRepeat.bind(_this);
	        return _this;
	    }

	    _createClass(LoginCreateForm, [{
	        key: 'changeUsername',
	        ...
	        key: 'changeRepeat',
	        value: function changeRepeat(event) {
	    ...
	    return LoginCreateForm;
	}(React.Component);

	var AuthController = function (_React$Component2) {
	    _inherits(AuthController, _React$Component2);

	    function AuthController(props) {
	        _classCallCheck(this, AuthController);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(AuthController).call(this, props));

	        _this2.login = _this2.login.bind(_this2);
	        _this2.createAccount = _this2.createAccount.bind(_this2);
	        return _this2;
	    }
	    ...
	    _createClass(AuthController, [{
	        ...
	        value: function login(username, password) {
	            Auth.Login(this.props.dispatch, username, password, this.props.wsConnection);
	        }
	    }, {
	        key: 'createAccount',
	        value: function createAccount(username, password, repeat) {
	            Account.Create(this.props.dispatch, username, password, repeat);
	        }
	    }, {
	        key: 'componentWillReceiveProps',
	        value: function componentWillReceiveProps(nextProps) {
	        ...
	        value: function render() {
	            return React.createElement(
	                'div',
	                null,
	                React.createElement(LoginCreateForm, {
	                    isFetching: this.props.isFetching,
	                    login: this.login,
	...
	var loginMapper = function loginMapper(state) {
	    return {
	...
	var Logout = function (_React$Component3) {
	    ...
	    function Logout(props) {
	        ...
	        _this3.clickLogout = _this3.clickLogout.bind(_this3);
	        return _this3;
	    }
	...
	;
	var logoutMapper = function logoutMapper(state) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexController = function (_React$Component) {
	    _inherits(IndexController, _React$Component);
